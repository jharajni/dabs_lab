...
The 'etl_pipeline_lab' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/etl_pipeline_lab/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] etl_pipeline_lab_etl` to your workspace.
